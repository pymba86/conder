...
using Conder.Auth.Dates;
using Microsoft.IdentityModel.Tokens;

namespace Conder.Auth.Handlers
{
    internal sealed class JwtHandler : IJwtHandler
    {
        ...
        public JwtHandler(JwtOptions options, TokenValidationParameters tokenValidationParameters)
        {
            ...
            {
                throw new InvalidOperationException("Security algorithm no set");
            }
        ...
        public JsonWebToken CreateToken(string userId, string role = null,
            string audience = null, IDictionary<string,
