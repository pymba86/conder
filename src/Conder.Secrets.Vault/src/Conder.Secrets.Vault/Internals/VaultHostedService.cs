...
namespace Conder.Secrets.Vault.Internals
{
    public class VaultHostedService : BackgroundService
    {
        ...
        public VaultHostedService(IVaultClient client, ILeaseService leaseService,
            ICertificatesIssuer certificatesIssuer, ICertificatesService certificatesService,
            VaultOptions options, ILogger<VaultHostedService> logger, int interval)
        {
            _client = client;
