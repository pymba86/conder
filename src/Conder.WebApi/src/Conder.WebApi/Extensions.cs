...
namespace Conder.WebApi
{
    public static class Extensions
    {
        ...
        public static IConderBuilder AddWebApi(this IConderBuilder builder,
        ...
        public static IApplicationBuilder UseEndpoints(this IApplicationBuilder app,
            Action<IEndpointsBuilder> build, bool useAuthorization = true,
        ...
        public static IConderBuilder AddErrorHandler<T>(this IConderBuilder builder)
        ...
        public static async Task<T> ReadJsonAsync<T>(this HttpContext httpContext)
        {
            if (httpContext.Request.Body is null)
            {
                ...
                await httpContext.Response.Body.WriteAsync(
                    InvalidJsonRequestBytes, 0, InvalidJsonRequestBytes.Length);
            ...
            try
            {
                ...
                var payload = await httpContext.RequestServices
                    .GetRequiredService<IJsonSerializer>().DeserializeAsync<T>(request.Body);
