...
namespace Conder.Metrics.AppMetrics
{
    public static class Extensions
    {
        ...
        public static IConderBuilder AddMetrics(this IConderBuilder builder,
        ...
        public static IConderBuilder AddMetrics(this IConderBuilder builder, MetricsOptions metricsOptions,
